...
\title{Supporting Information for "Surface Winds and Enthalpy Fluxes During Tropical Cyclone Formation From Easterly Waves: A CYGNSS view"}
%
...
In this section, we provide some additional information on the CYGNSS data amid tropical cyclone cases that were used in the paper.
...
As described in  \cite{2019BAMS}, two categories of CYGNSS wind speeds and surface fluxes are available:  One, referred to as the fully developed seas (FDS), assumes that the sea state is in equilibrium with the surface winds; and the second, referred to as the young-seas limited fetch winds (YSLF), assumes that the long-wave portion of the sea state has not responded fully to the local surface winds. The latter is a relatively more robust estimate of high winds typical of hurricanes \cite{2019BAMS}. Since our focus is on AEWs transitioning to tropical cyclones, and we restricted our attention to a couple of days post-tropical depression, we only present calculations  using FDS winds. However, when we duplicated the calculations using YSLF winds, our interpretations and conclusions were qualitatively unchanged (not shown).  The uncertainty associated with CYGNSS wind retrievals is continuing to be assessed and reported in the literature \cite<e.g.,>{2019BAMS}.  For speeds less than 20 ms$^{-1}$, the uncertainty in the  CYGNSS FDS wind speed was found to be less than 2 ms$^{-1}$ when compared with tropical buoy measurements \cite{A2021JAtOT}. The conclusions drawn from our results are not sensitive to this uncertainty.



Figure S1 illustrates the typical CYGNSS wind fields associated with an AEW. It shows the daily averaged Level 3 FDS wind speeds and 10m ERA5 wind vectors during the six days leading to the genesis of hurricane Grace in 2021. The vector winds clearly depict a wave train over the Atlantic and the specific wave trough that eventually resulted in cyclogenesis. 

The genesis locations of the 30 storms that formed from AEWs during July--October, 2018--2021 are shown in Fig. S2.
...
% 
%
\bibliography{aiyyer_references} do not specify file extension
%
...
\begin{figure}
 \includegraphics[width=30pc]{Grace_2021L3.png}
 \caption{CYGNSS daily averaged Level 3 FDS wind speeds and 10m ERA5 wind vectors during the six days leading to the genesis of hurricane Grace in 2021.}
 \label{fig:grace}
\end{figure}
...
\begin{figure}
 \includegraphics[width=30pc]{tc_locs.png}
 \caption{Genesis location of all Tropical Cyclones that were associated with African easterly waves as determined by the National Hurricane Center during 2018--2021.}
 \label{fig:TCs}
\end{figure}
