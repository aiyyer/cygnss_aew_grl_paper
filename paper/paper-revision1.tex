...
We now consider the evolution of surface wind speeds during the time of tropical cyclogenesis from AEWs. A total of 30 tropical cyclones were deemed to originate from AEWs within the MDR during the study period. The genesis locations of these storms are shown in Fig. S2. To document the surface wind evolution, we calculated storm-relative composites as follows. We shifted the data grids such that all storms shown in Figure S2 are co-located at a reference point (10$^o$N; 40$^o$W) on the day of tropical cyclogenesis (Day-0). For lag composites, we moved the date forward and backward relative to the date of cyclogenesis while retaining the same spatial shift. Although there may be considerable storm-to-storm variability, such compositing techniques elucidate the features that are most likely to occur in a synoptic phenomenon \cite{WZ2018}.
